...
public class TaskRepository {
    ...
    public void cadastrar(Task task)
        ...
        try{
            ...
            throw new Exception("Task não poderá ser cadastrada!");
        }
    }
    ...
    public void deletar(Integer id) throws Exception{
        try{
            ...
            throw new Exception("Task não poderá ser deletada!");
        }
    }

    public void editarTask(Task task, Integer id)
            throws Exception{
        try{
            ...
            throw new Exception("Ocorreu um erro ao editar task");
        }
    }
}
